...
W pliku konfiguracyjnym nadzorca odczytuje dwie sekcji:
\begin{itemize}
...
Sekcja ta zawiera jedynie parametr \texttt{Secret}. Należy go ustawić na dowolny napis. W przypadku uruchamiania więcej niż jednej instancji nadzorcy taka sama wartość parametru pozwala na zmianę nadzorcy bez konieczności ponownej autoryzacji.
