...
Sekcja ta zawiera jedynie parametr \texttt{Secret}. Należy go ustawić na dowolny napis. W przypadku uruchamiania więcej niż jednej instancji nadzorcy użycie identycznej wartości parametru może być porządane. Pozwala to na bezproblemową zmianę nadzorcy, z którym przebiega komunikacja, bez potrzeby ponownej autoryzacji.
...
\begin{itemize}
  ...
  \item \texttt{Ldap} - przechowuje parametry systemu katalogowego przechowującego użytkowników.
...
\begin{itemize}
  ...
  \item \texttt{NvramPath} - % TODO: dodać
