...
\begin{itemize}
	...
	\item Serwer wirtualizacji - komputer, który udostępnia swoje zasoby (CPU, GPU, pamięć, przestrzeń dyskową) w postaci uruchamianych na nim maszyn wirtualnych. Dodatkowo na tym komputerze będzie uruchomiana aplikacja, która będzie odpowiadać na pytania aplikacji nadzorczej oraz 
...
\subsection{Nadzorca}
\includegraphics[width=\textwidth]{../diagrams/use_cases/overseer.drawio.png}
...
\includegraphics[width=\textwidth]{../diagrams/use_cases/virtualisation_server.drawio.png}
...
\includegraphics[width=\textwidth]{../diagrams/use_cases/admin_panel.drawio.png}
