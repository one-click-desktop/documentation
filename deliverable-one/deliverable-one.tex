...
\begin{center}
	\begin{table}[h!]
		\begin{tabular}{|p{0.08\textwidth}|p{0.17\textwidth}|p{0.375\textwidth}|p{0.375\textwidth}|}
			...
			\multirow{10}{=}{\rotatebox{90}{Użytkownik}}                                    & Uzyskanie sesji do pracy          & Uzyskanie sesji do pracy na maszynie wirtualnej CPU lub GPU   & Do użytkownika zostaje przydzielona maszyna wirtualna oraz zestawione połączenie RDP                                                                          \\ \cline{2-4}
